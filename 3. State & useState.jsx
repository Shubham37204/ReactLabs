...
function App() {
  ...
  return (
    <div>
     ...
     <button id="increment" onClick={ChangeCountByOne}>+</button>
     <button id="decrement" onClick={ChangeCountByNegativeOne}>-</button>
     <button id="reset" onClick={ChangeCountToZero}>0</button>
    </div>
  );
}
